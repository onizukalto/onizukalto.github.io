        ...
        <html>
            ...
            <body>
                ...
                <div class="section">
                    ...
                    <div class="item"><span class="item-title">Name:</span> <span class="item-details"><xsl:value-of select="CV/PersonalInformation/Name"/></span></div>
                    <div class="item"><span class="item-title">Address:</span> <span class="item-details"><xsl:value-of select="CV/PersonalInformation/Address"/></span></div>
                    <div class="item"><span class="item-title">Phone:</span> <span class="item-details"><xsl:value-of select="CV/PersonalInformation/Phone"/></span></div>
