    ...
    <xsl:template match="/">
        <html>
            ...
            <body>
                ...
                <div class="section">
                    <div class="section-title">個人情報</div>
                    <div class="item"><span class="item-title">名前:</span> <span class="item-details"><xsl:value-of select="CV/PersonalInformation/Name"/></span></div>
                    <div class="item"><span class="item-title">住所:</span> <span class="item-details"><xsl:value-of select="CV/PersonalInformation/Address"/></span></div>
                    <div class="item"><span class="item-title">電話番号:</span> <span class="item-details"><xsl:value-of select="CV/PersonalInformation/Phone"/></span></div>
                    <div class="item"><span class="item-title">メール:</span> <span class="item-details"><xsl:value-of select="CV/PersonalInformation/Email"/></span></div>
                ...
                <div class="section">
                    ...
                    <div class="skills-container">
                        <div class="skills-column">
                            <div class="subsection-title">言語</div>
                            <ul>
                        ...
                        <div class="skills-column">
                            <div class="subsection-title">ソフトスキル</div>
                            <ul>
                    ...
                    <div class="subsection" style="margin-top: 20px;">
                        <div class="subsection-title">技術的スキル</div>
